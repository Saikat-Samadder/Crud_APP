            ...
            <h1 style={{ fontWeight: 400 }}>Welcome Harsh Pathak</h1>
                ...
                <CardContent>
                    ...
                    <NavLink to={`/edit/${getuserdata.id}`}>  <button className="btn btn-primary mx-2"><CreateIcon /></button></NavLink>
                        <button className="btn btn-danger" onClick={() => deleteuser(getuserdata.id)}><DeleteIcon /></button>
                    </div>
                    <div className="row">
                        ...
                        <div className="right_view  col-lg-6 col-md-6 col-12">
                            ...
                            <p className="mt-5"><PhoneIphoneIcon />mobile: <span>+91 {getuserdata.mobile}</span></p>
